...
export declare const formatDate: (date: Date | null, dateFormat: string, formatOptions?: FnsFormatOptions | undefined) => string | undefined;
...
export declare const formatSelectedDate: (selectedDate: Date | Date[] | null | undefined, dateFormat: string, formatOptions?: FnsFormatOptions | undefined) => string | undefined;
